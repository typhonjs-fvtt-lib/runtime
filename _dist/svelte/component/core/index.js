import { SvelteComponent, init, safe_not_equal, flush, append_styles, empty, insert, group_outros, transition_out, check_outros, transition_in, detach, create_component, mount_component, noop, destroy_component, create_slot, element, attr, listen, update_slot_base, get_all_dirty_from_scope, get_slot_changes, add_render_callback, create_in_transition, create_out_transition, text, append, set_data, space, action_destroyer, is_function, destroy_each, run_all, component_subscribe, null_to_empty, set_style, create_bidirectional_transition, HtmlTag, stop_propagation, prevent_default, update_keyed_each, destroy_block, binding_callbacks, globals, get_spread_update, get_spread_object, assign, add_resize_listener, current_component, bind, add_flush_callback } from 'svelte/internal';
...
import { isSvelteComponent, parseSvelteConfig, outroAndDestroy } from '@typhonjs-fvtt/runtime/svelte/util';
