...
// `util/i18n` & `util/path` is skipped, because a platform specific implementation for Foundry VTT is added locally.

const s_EXCLUDE = ['./package.json', './util/i18n', '.util/path'];
