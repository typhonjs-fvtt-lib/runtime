...
class LocalStorage {
  constructor() {
    _classPrivateFieldInitSpec$1(this, _storage, {
      writable: true,
      value: new LocalStorage$1()
    });
  }

  onPluginLoad(ev) {
    var _ev$pluginOptions;

    const prepend = typeof (ev === null || ev === void 0 ? void 0 : (_ev$pluginOptions = ev.pluginOptions) === null || _ev$pluginOptions === void 0 ? void 0 : _ev$pluginOptions.eventPrepend) === 'string' ? `${ev.pluginOptions.eventPrepend}:` : '';
    ev.eventbus.on(`${prepend}storage:local:item:get`, _classPrivateFieldGet$1(this, _storage).getItem, _classPrivateFieldGet$1(this, _storage), {
      guard: true
    });
    ev.eventbus.on(`${prepend}storage:local:item:boolean:swap`, _classPrivateFieldGet$1(this, _storage).swapItemBoolean, _classPrivateFieldGet$1(this, _storage), {
      guard: true
    });
    ev.eventbus.on(`${prepend}storage:local:item:set`, _classPrivateFieldGet$1(this, _storage).setItem, _classPrivateFieldGet$1(this, _storage), {
      guard: true
    });
    ev.eventbus.on(`${prepend}storage:local:store:get`, _classPrivateFieldGet$1(this, _storage).getStore, _classPrivateFieldGet$1(this, _storage), {
      guard: true
    });
  }
...
class SessionStorage {
  constructor() {
    _classPrivateFieldInitSpec$1(this, _storage2, {
      writable: true,
      value: new SessionStorage$1()
    });
  }

  onPluginLoad(ev) {
    var _ev$pluginOptions2;

    const prepend = typeof (ev === null || ev === void 0 ? void 0 : (_ev$pluginOptions2 = ev.pluginOptions) === null || _ev$pluginOptions2 === void 0 ? void 0 : _ev$pluginOptions2.eventPrepend) === 'string' ? `${ev.pluginOptions.eventPrepend}:` : '';
    ev.eventbus.on(`${prepend}storage:session:item:get`, _classPrivateFieldGet$1(this, _storage2).getItem, _classPrivateFieldGet$1(this, _storage2), {
      guard: true
    });
    ev.eventbus.on(`${prepend}storage:session:item:boolean:swap`, _classPrivateFieldGet$1(this, _storage2).swapItemBoolean, _classPrivateFieldGet$1(this, _storage2), {
      guard: true
    });
    ev.eventbus.on(`${prepend}storage:session:item:set`, _classPrivateFieldGet$1(this, _storage2).setItem, _classPrivateFieldGet$1(this, _storage2), {
      guard: true
    });
    ev.eventbus.on(`${prepend}storage:session:store:get`, _classPrivateFieldGet$1(this, _storage2).getStore, _classPrivateFieldGet$1(this, _storage2), {
      guard: true
    });
  }
...
var _gameSettings = /*#__PURE__*/new WeakMap();

class TJSGameSettings {
  constructor() {
    _classPrivateFieldInitSpec$1(this, _gameSettings, {
      writable: true,
      value: new TJSGameSettings$1()
    });
  }
  ...
  register(moduleId, key, options) {
    ...
    const onChange = typeof (options === null || options === void 0 ? void 0 : options.onChange) === 'function' ? [options.onChange] : [];
    onChange.push(value => {
      if (this._eventbus) {
        this._eventbus.trigger(`tjs:system:game:settings:change:any`, {
          setting: key,
          value
        });
    ...
    _classPrivateFieldGet$1(this, _gameSettings).register(moduleId, key, _objectSpread2(_objectSpread2({}, options), {}, {
      onChange
    }));
  }
  /**
  ...
  onPluginLoad(ev) {
    ...
    ev.eventbus.on(`tjs:system:game:settings:store:get`, _classPrivateFieldGet$1(this, _gameSettings).getStore, _classPrivateFieldGet$1(this, _gameSettings), opts);
