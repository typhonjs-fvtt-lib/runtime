import { linear } from '/modules/typhonjs/svelte/easing.js';
...
function rotate(node, options) {
  var _options$easing, _options$initial, _options$end, _options$delay, _options$duration;

  const easingRotate = (_options$easing = options.easing) !== null && _options$easing !== void 0 ? _options$easing : linear;
  const initialDeg = (_options$initial = options.initial) !== null && _options$initial !== void 0 ? _options$initial : 0;
  const endDeg = (_options$end = options.end) !== null && _options$end !== void 0 ? _options$end : 0;
  return {
    delay: (_options$delay = options.delay) !== null && _options$delay !== void 0 ? _options$delay : 0,
    duration: (_options$duration = options.duration) !== null && _options$duration !== void 0 ? _options$duration : 500,
    easing: linear,
    css: t => {
...
function rotateFade(node, options) {
  var _options$initial2, _options$end2, _options$delay2, _options$duration2;
  ...
  const initialDeg = (_options$initial2 = options.initial) !== null && _options$initial2 !== void 0 ? _options$initial2 : 0;
  const endDeg = (_options$end2 = options.end) !== null && _options$end2 !== void 0 ? _options$end2 : 0;
  return {
    delay: (_options$delay2 = options.delay) !== null && _options$delay2 !== void 0 ? _options$delay2 : 0,
    duration: (_options$duration2 = options.duration) !== null && _options$duration2 !== void 0 ? _options$duration2 : 500,
    easing: linear,
    css: t => {
